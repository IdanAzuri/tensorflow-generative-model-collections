...
python3 main.py --gan_type MultiModalInfoGAN --epoch 60 --dataset fashion-mnist --sampler multi-gaussian --batch_size 64 --mu 0.1 --sigma 0.2 --dataset_order "czcc czrc rzcc rzrc" --original fashion-mnist

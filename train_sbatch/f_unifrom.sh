...
python3 classifier.py --dir_name /cs/labs/daphna/idan.azuri/tensorflow-generative-model-collections/ --fname fashion-mnist_UniformSample_mu_0_sigma_0.15_czcc_czrc_rzcc_rzrc_ndist_10 --original fashion-mnist
#
#python3 main.py --gan_type MultiModalInfoGAN --epoch 60 --dataset fashion-mnist --sampler uniform --batch_size 64 --dataset_order "czcc rzcc czrc rzrc"
...
#
#python3 main.py --gan_type MultiModalInfoGAN --epoch 60 --dataset fashion-mnist --sampler uniform --batch_size 64 --dataset_order "rzcc rzrc czcc czrc"
...
#
#
#python3 main.py --gan_type MultiModalInfoGAN --epoch 60 --dataset fashion-mnist --sampler uniform --batch_size 64 --dataset_order "czrc czcc rzcc rzrc"

...
python3 main.py --gan_type MultiModalInfoGAN --epoch 60 --dataset fashion-mnist --sampler uniform --batch_size 64 --dataset_order "czcc czrc rzcc rzrc" --original fashion-mnist

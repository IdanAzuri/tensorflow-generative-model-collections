...
python3 main.py --gan_type MultiModalInfoGAN --epoch 60 --dataset mnist --sampler gaussian --batch_size 64 --mu 0.0 --sigma 0.2 --dataset_order "czcc czrc rzcc rzrc" --original fashion-mnist
...
python3 classifier.py --dir_name /cs/labs/daphna/idan.azuri/tensorflow-generative-model-collections/ --fname mnist_GaussianSample_mu_0.0_sigma_0.2_czcc_czrc_rzcc_rzrc --original mnist

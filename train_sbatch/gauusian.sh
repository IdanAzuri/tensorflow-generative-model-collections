...
python3 main.py --gan_type MultiModalInfoGAN --epoch 60 --dataset mnist --sampler gaussian --batch_size 64 --mu 0.0 --sigma 0.2 --dataset_order "czcc czrc rzcc rzrc" 0.2

...
class CNNClassifier():
	def __init__(self, classifier_name, load_from_pkl=False, pkl_fname=None, dir=None, original_dataset_name='mnist', dir_results='classifier_results_with_confidence'):
		self.num_epochs = 30
	...
	def plot_train_test_loss(self, name_of_measure, array, color="b", marker="P", dir="classifier_results_with_confidence/"):
		plt.Figure()
...
def preprocess_data(dir, pkl_fname, original_dataset_name='mnist', batch_size=64, dir_results="classifier_results_with_confidence"):

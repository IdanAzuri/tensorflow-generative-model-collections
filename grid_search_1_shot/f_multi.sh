...
python3 main.py --gan_type MultiModalInfoGAN --epoch 40 --dataset mnist --sampler multi-gaussian --batch_size 64 --mu 0.7 --sigma 0.3  --ndist 5 --seed 12 --pref one-shot_gram
...
python3 main.py --gan_type MultiModalInfoGAN --epoch 40 --dataset mnist --sampler multi-gaussian --batch_size 64 --mu 0.7 --sigma 0.3  --ndist 3 --seed 12 --pref one-shot_gram
...
python3 main.py --gan_type MultiModalInfoGAN --epoch 40 --dataset mnist --sampler multi-gaussian --batch_size 64 --mu 0.2 --sigma 0.2  --ndist 5 --seed 12 --pref one-shot_gram
...
python3 main.py --gan_type MultiModalInfoGAN --epoch 40 --dataset mnist --sampler multi-gaussian --batch_size 64 --mu 0.2 --sigma 0.2  --ndist 3 --seed 12 --pref one-shot_gram

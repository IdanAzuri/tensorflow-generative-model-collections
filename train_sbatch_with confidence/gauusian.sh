...
python3 main.py --gan_type MultiModalInfoGAN --epoch 40 --dataset mnist --sampler gaussian --batch_size 64 --mu 0.0 --sigma 0.3 --dataset_order "czcc czrc rzcc rzrc" --result_dir results_with --original fashion-mnist

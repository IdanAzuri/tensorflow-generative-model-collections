...
python3 main.py --gan_type MultiModalInfoGAN --epoch 40 --dataset mnist --sampler uniform --batch_size 64 --dataset_order "rzcc rzrc czcc czrc" --result_dir results_with_confidence
...
python3 main.py --gan_type MultiModalInfoGAN --epoch 40 --dataset mnist --sampler uniform --batch_size 64 --dataset_order "czrc czcc rzcc rzrc" --result_dir results_with_confidence
